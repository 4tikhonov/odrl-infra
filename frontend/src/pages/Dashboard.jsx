    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Link to="/dids" className="block p-6 rounded-xl bg-white border border-gray-200 dark:bg-[#242424] dark:border-white/10 hover:border-indigo-500/50 transition-colors shadow-sm dark:shadow-none hover:shadow-md">
                ...
                <Link to="/vcs" className="block p-6 rounded-xl bg-white border border-gray-200 dark:bg-[#242424] dark:border-white/10 hover:border-cyan-500/50 transition-colors shadow-sm dark:shadow-none hover:shadow-md">
                ...
                <Link to="/policies" className="block p-6 rounded-xl bg-white border border-gray-200 dark:bg-[#242424] dark:border-white/10 hover:border-purple-500/50 transition-colors shadow-sm dark:shadow-none hover:shadow-md">
